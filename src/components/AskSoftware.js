            ...
            >
                <div className='flex lg:justify-between justify-start items-end lg:flex-row md:flex-row flex-col lg:mx-0 mx-2 lg:mb-0 mb-4'>
                    ...
                    <div className='lg:mt-0 md:mt-0 mt-4'>
                        <button className='py-2 px-4 rounded bg-[#00B3FF] border border-transparent hover:border hover:border-[#00B3FF] hover:bg-transparent duration-500 text-white hover:text-black'>Contact us</button>
                    </div>
                </div>
                <div></div>
            </div>
